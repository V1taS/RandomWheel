...
extension ImageDrawing {
  ...
  func drawImage(in context: CGContext,
    ...
    let rectangle = CGRect(x: -(aspectRatioRect.size.width / 2),
                           y: -yPosition,
                           width: aspectRatioRect.size.width,
                           height: aspectRatioRect.size.height)
  ...
  func drawAnchorImage(in context: CGContext,
                       imageAnchor: SFWConfiguration.AnchorImage,
                       isCentered: Bool,
                       rotation: CGFloat,
                       index: Int,
                       radius: CGFloat,
